...
import { Card, CardDecoration, CardContent, CardBadge, CardTitle, CardStats, CardStat } from './ui/Card';
...
const PredictionCard: React.FC<PredictionCardProps> = ({
  ...
  return (
    <Card className={cn("w-full max-w-[340px] mx-auto", className)}>
      <CardDecoration />
      <CardContent>
        <div className="flex items-center justify-between mb-3">
          <CardBadge variant="orange">Live</CardBadge>
          <CardBadge variant="emerald">{multiplier}</CardBadge>
        </div>
